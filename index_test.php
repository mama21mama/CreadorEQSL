...
<head>
    ...
    <title>Creador QSL - Custom</title>
<style>
        body {
...
<br>
 <div class="container">
<img src="thumb.php?img=https://reisub.nsupdate.info/qsl/uploads/qsl_custom.png&height=75" alt="preview" width="" height="">
</br><font size="1">Plantilla Base a usar...</font>
   <form action="/qsl/uploads/procesar_test.php">
	<input type="text" name="miqra" required placeholder="Mi QRA y Nombre">
        <input type="text" name="qra" required placeholder="QRA">
