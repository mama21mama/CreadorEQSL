...
<br>
 <div class="container">
<img src="thumb.php?img=https://reisub.nsupdate.info/qsl/uploads/P2_A6.png&height=75" alt="preview" width="" height="">
</br><font size="1">Plantilla Base a usar...</font>
   <form action="/qsl/uploads/P2_A6_procesar.php">
	...
	<input type="text" name="nota" placeholder="COMENTARIOS">
