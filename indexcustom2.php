...
<br>
 <div class="container">
<img src="thumb.php?img=https://reisub.nsupdate.info/qsl/uploads/qslcustom2.png&height=75" alt="preview" width="" height="">
</br><font size="1">Plantilla Base a usar...</font>
   <form action="/qsl/uploads/procesarcustom2.php">
	...
	<input type="text" name="nota1" placeholder="Mi Nota">
